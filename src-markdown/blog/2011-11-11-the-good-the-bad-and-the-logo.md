...
Back in **June 2010** I wrote about [using SVG](http://dbushell.com/2010/06/30/using-svg-logos/) for your logo. When I realigned my website earlier this year (see: [Designing a new me](http://dbushell.com/2011/05/25/designing-a-new-me/)) I reverted back to the typical PNG and used the `-webkit-min-device-pixel-ratio` to provide a high-res version.
