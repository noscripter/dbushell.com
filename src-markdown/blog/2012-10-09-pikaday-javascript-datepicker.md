...
{%p class="post__image"%}![Pikaday screenshot](/wp-content/uploads/2012/10/pikaday.png){%/p%}
...
{%p class="post__image"%}![Chrome date input](/wp-content/uploads/2012/10/dateinput1.png){%/p%}
