...
{%p class="post__image"%}![Houden hero unit designed in CodePen](http://dbushell.com/wp-content/uploads/2015/03/houden-hero-codepen-dev.png){%/p%}
...
{%p class="post__image"%}![Houden hero unit (alternate designs)](http://dbushell.com/wp-content/uploads/2015/03/houden-hero-alt.png){%/p%}
...
{%p class="post__image"%}![Houden product features](http://dbushell.com/wp-content/uploads/2015/03/houden-product-features.png){%/p%}
