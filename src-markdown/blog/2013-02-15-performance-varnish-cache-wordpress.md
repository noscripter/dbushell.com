...
{%p class="post__image"%}![Reverse_proxy_h2g2bob](/wp-content/uploads/2013/02/Reverse_proxy_h2g2bob.svg){%/p%}
...
{%p class="post__image"%}![latest articles on dbushell.com](/wp-content/uploads/2013/02/from-the-blog.png){%/p%}
